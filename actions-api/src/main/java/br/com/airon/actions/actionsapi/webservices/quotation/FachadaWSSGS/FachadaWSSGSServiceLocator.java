...
public class FachadaWSSGSServiceLocator extends org.apache.axis.client.Service implements br.com.airon.actions.actionsapi.webservices.quotation.FachadaWSSGS.FachadaWSSGSService {
    ...
    public br.com.airon.actions.actionsapi.webservices.quotation.FachadaWSSGS.FachadaWSSGS getFachadaWSSGS() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.airon.actions.actionsapi.webservices.quotation.FachadaWSSGS.FachadaWSSGS getFachadaWSSGS(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.airon.actions.actionsapi.webservices.quotation.FachadaWSSGS.FachadaWSSGSSoapBindingStub _stub = new br.com.airon.actions.actionsapi.webservices.quotation.FachadaWSSGS.FachadaWSSGSSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.airon.actions.actionsapi.webservices.quotation.FachadaWSSGS.FachadaWSSGS.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.airon.actions.actionsapi.webservices.quotation.FachadaWSSGS.FachadaWSSGSSoapBindingStub _stub = new br.com.airon.actions.actionsapi.webservices.quotation.FachadaWSSGS.FachadaWSSGSSoapBindingStub(new java.net.URL(FachadaWSSGS_address), this);
                _stub.setPortName(getFachadaWSSGSWSDDServiceName());
                return _stub;
            }
        }
